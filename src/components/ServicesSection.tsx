...
export function ServicesSection() {
  return (
    <section className="py-20 md:py-28 bg-background" id="servicos">
      <div className="container">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-secondary/10 text-secondary text-sm font-medium mb-4">Nossos Serviços</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((s, i) => (
            ...
            >
              <Link
                to="/servicos"
                className="group block bg-card rounded-xl p-6 shadow-card hover:shadow-elevated transition-all duration-300 border border-border hover:border-primary/20 h-full"
              >
                <div className="w-12 h-12 rounded-lg bg-primary/10 group-hover:gradient-primary flex items-center justify-center mb-4 transition-all duration-300">
