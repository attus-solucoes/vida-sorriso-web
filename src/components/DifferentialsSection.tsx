...
export function DifferentialsSection() {
  return (
    <section className="py-16 md:py-24 bg-dark-section noise-overlay relative overflow-hidden">
      {/* Glow orbs */}
      <div className="absolute w-[400px] h-[400px] top-0 right-0 rounded-full bg-primary/6 blur-[120px]" />
      <div className="absolute w-[300px] h-[300px] bottom-0 left-0 rounded-full bg-secondary/5 blur-[100px]" />
      ...
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {differentials.map((item, i) => (
            ...
            >
              <div className="w-14 h-14 rounded-2xl gradient-primary flex items-center justify-center mx-auto mb-4 shadow-glow glow-icon">
